...
namespace Calisan_Yonetim_Core.Migrations
{
    ...
    [Migration("20241118225837_updated_user_model_password_property_type")]
    partial class updated_user_model_password_property_type
    {
            ...
            modelBuilder.Entity("Calisan_Yonetim_Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8153bc1e-5ac3-4586-a0cf-f155039c15d2"),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            RoleId = new Guid("dbdd5c8d-1183-4e6e-906e-d9dbd463c5d1"),
                            RoleName = "User",
                            Status = 1
                        });
                });
